  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-[50vh]">
        <div className="animate-pulse text-muted-foreground">Cargando evento...</div>
      </div>
    )
  }
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <span className="text-sm font-normal text-muted-foreground">
              {event.max_participants - currentParticipants} lugares disponibles
            </span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <p className="text-sm text-muted-foreground mt-2">
            {capacityPercentage.toFixed(0)}% de la capacidad
          </p>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent>
            <Link 
              ...
              className="flex items-center gap-4 p-4 rounded-lg border border-[#0D5E32]/20 hover:bg-muted/50 transition-colors"
            >
